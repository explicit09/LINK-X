...
-- With fixes for existing triggers
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'study_sessions' AND policyname = 'Users can view their own study sessions'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'study_sessions' AND policyname = 'Users can create their own study sessions'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'study_sessions' AND policyname = 'Users can update their own study sessions'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'study_sessions' AND policyname = 'Users can delete their own study sessions'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'study_plans' AND policyname = 'Users can manage their own study plans'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'study_goals' AND policyname = 'Users can manage their own study goals'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'user_schedules_preferences' AND policyname = 'Users can manage their own preferences'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'session_notes' AND policyname = 'Users can manage their own session notes'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'session_analytics' AND policyname = 'Users can view their own analytics'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'session_analytics' AND policyname = 'System can insert analytics'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'ai_session_suggestions' AND policyname = 'Users can manage their own AI suggestions'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tgname = 'update_study_plans_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'update_study_goals_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'update_user_schedules_preferences_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'update_session_notes_updated_at'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'user_stats' AND policyname = 'Users can view and update their own stats'
    ) THEN
