...
//               {/* {item.progress && (
//                 <Progress value={item.progress} className="bg-black" indicatorClassName="bg-blue-500" />
//               )} */}
...
//           <CardHeader>
//             <CardTitle className="text-xl text-blue-400">Recommended Courses</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//             {["Introduction to Investing", "Financial Statement Analysis", "Risk Management Basics"].map(
//               (course, index) => (
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6 md:p-8 lg:p-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-blue-500/20 shadow-lg">
          ...
          <CardContent>
            <ul className="space-y-4">
              {["Advanced Stock Trading", "Cryptocurrency Fundamentals", "Personal Finance Mastery"].map((course, index) => (
                <li key={index} className="flex items-center justify-between bg-gray-800/50 p-3 rounded-lg">
                  <span className="text-white">{course}</span>
                  <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white flex items-center">
                    Enroll <ChevronRight className="ml-2 h-4 w-4" />
                  </Button>
                </li>
              ))}
