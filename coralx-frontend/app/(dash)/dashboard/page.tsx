        ...
        <main className={cn("pt-6 transition-all duration-300", isCollapsed ? "px-6 md:px-8 lg:px-12" : "px-4")}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              ...
              <Card key={idx} className="bg-gradient-to-br from-gray-900 to-gray-800 border-blue-500/20 shadow-lg">
          ...
          {/* Course search and market chart */}
              ...
              <CardContent>
                <div className="flex flex-col sm:flex-row gap-3 mb-4">
                  ...
                  <Button className="bg-green-600 hover:bg-green-700 text-white h-10 px-4 shadow-md shadow-green-900/20 border border-green-500/30 whitespace-nowrap">
                    <Plus className="h-5 w-5 mr-2" /> Upload Course
                  </Button>
                </div>
                <ul className="space-y-4">
                  {["Advanced Stock Trading", "Cryptocurrency Fundamentals", "Personal Finance Mastery"].map((course, idx) => (
                    <li key={idx} className="flex items-center justify-between bg-gray-800/50 p-3 rounded-lg">
          ...
          <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-blue-500/20 shadow-lg mb-12">
            <CardHeader>
              <CardTitle className="text-xl text-blue-400">Recently Completed Courses</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {["Introduction to Investing", "Financial Statement Analysis", "Risk Management Basics"].map((course, idx) => (
