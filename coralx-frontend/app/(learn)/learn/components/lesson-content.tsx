export default function LessonContent() {
  return (
    <div className="max-w-5xl w-full p-8">
      <h1 className="text-3xl font-bold mb-6 text-blue-foreground">Introduction to Cryptocurrency</h1>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-muted">Key Concepts</h2>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-foreground">
        <li><strong>Decentralization:</strong> No central authority controls cryptocurrency</li>
        <li><strong>Blockchain:</strong> A distributed ledger technology that records all transactions</li>
        <li><strong>Cryptography:</strong> Ensures secure transactions and controls the creation of new units</li>
        <li><strong>Digital Wallets:</strong> Where users store their cryptocurrency</li>
      </ul>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-muted">Advantages of Cryptocurrency</h2>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-foreground">
