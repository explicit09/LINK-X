...
export function PDFThumbnail({ materialId, title, className }: PDFThumbnailProps) {
  ...
  return (
    <div className={cn("relative bg-white border-2 border-red-200 shadow-sm rounded-lg overflow-hidden", className)}>
