...
export function StreamingMetrics({
  sectionKey,
  isStreaming,
}: { sectionKey: string; isStreaming: boolean }) {
    ...
    <Card className="fixed bottom-4 left-4 w-80 shadow-lg border-gray-200 bg-white/95 backdrop-blur z-50">
      <CardHeader className="pb-3">
        <CardTitle className="text-sm font-medium">
          Performance Metrics - {sectionKey}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-2 text-xs">
        <div className="flex items-center justify-between">
          ...
          <span
            className={`font-mono ${getMetricColor('firstToken', metrics.firstTokenTime || 0)}`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`font-mono ${getMetricColor('completion', metrics.completionTime || 0)}`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`font-mono ${getMetricColor('droppedFrames', metrics.droppedFrames)}`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`font-mono ${getMetricColor('memory', metrics.memoryUsage)}`}
          >
