          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mb-1">
              ...
              <Badge className={cn(
                ...
                {file.error ? 'Error' : file.processed ? 'Processed' : 'Processing'}
              </Badge>
            </div>
            ...
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              {formatUploadDate(file.uploadedAt) && (
                <>
                  {formatFileSize(file.size) && <span className="text-gray-400">•</span>}
            ...
            {file.error && (
              <p className="text-xs text-red-600 mt-1 truncate font-medium" title={file.error}>
                {file.error}
              </p>
            )}
          </div>
