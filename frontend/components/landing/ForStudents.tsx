  ...
  const benefits = [
    {
      ...
      description:
        'Collaborate with TAs and professors to further improve your learning.',
      icon: GraduationCap,
    },
    {
      title: 'Team Collaboration',
      description:
        'Develop teamwork skills by working with peers on real-world challenges and projects.',
      icon: Users,
    },
    {
      title: 'Test Practice',
      description:
        'Create practice work to better prepare for upcoming quizzes and tests.',
      icon: Code,
    },
    {
      title: 'Lecture Help',
      description:
        'Your professor explained a complicated topic in a way you didn&apos;t understand. No problem! Reworded and reworked lessons will help you further your education.',
      icon: BarChart,
    },
  ];
      ...
      <div className="section-inner">
        <div className="text-center mb-16">
          ...
          <p className="reveal max-w-2xl mx-auto text-gray-600">
            Learn-X doesn&apos;t just teach class concepts — it equips you with
