  ...
  return (
    ...
    >
      <CardContent className="p-6 text-center relative">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-r from-purple-100/20 via-blue-100/20 to-transparent opacity-0 animate-pulse"
        ...
        <p className="canvas-small text-purple-600 mb-4 leading-relaxed">
          Stuck? Highlight anything or click here to ask your AI tutor
          instantly.
        </p>
