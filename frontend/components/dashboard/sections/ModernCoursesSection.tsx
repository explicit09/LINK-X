                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      {urgencyBadge && (
                        <div
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mb-2 ${urgencyBadge.color}`}
                        >
                          {urgencyBadge.text}
                        </div>
                      )}
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="left" className="max-w-xs">
                          <div className="space-y-1">
                            <p
                              className={`font-medium text-xs ${aiInsight.color}`}
                            >
                              {aiInsight.title}
                            </p>
