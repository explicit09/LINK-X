        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">{code}</p>
            </div>
            <motion.div
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">{students} students</span>
              </div>
              {lastActivity && (
                <span className="text-xs font-medium text-gray-500">{lastActivity}</span>
              )}
            </div>
          </div>
        </CardContent>
...
export default function ModernDashboardV2({ 
  ...
  const [activeFilter, setActiveFilter] = useState<'semester' | 'ai' | null>('semester');
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
            ...
            >
              ...
              <div className="flex gap-2">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setActiveFilter(activeFilter === 'semester' ? null : 'semester')}
                  className={cn(
          ...
          <section className="pb-8">
            <motion.div 
              ...
              className="mb-6"
            >
              <h2 className="text-2xl font-medium text-gray-900">Your Courses</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {[
                { id: '1', title: 'Introduction to Computer Science', code: 'CS101', students: 245, progress: 85, color: 'bg-gradient-to-r from-blue-500 to-purple-500', lastActivity: '2 hours ago' },
                { id: '2', title: 'Data Structures & Algorithms', code: 'CS201', students: 189, progress: 72, color: 'bg-gradient-to-r from-green-500 to-teal-500', lastActivity: '1 day ago' },
                { id: '3', title: 'Web Development Fundamentals', code: 'WEB101', students: 312, progress: 90, color: 'bg-gradient-to-r from-orange-500 to-red-500', lastActivity: '3 hours ago' },
                { id: '4', title: 'Machine Learning Basics', code: 'ML101', students: 156, progress: 45, color: 'bg-gradient-to-r from-purple-500 to-pink-500', lastActivity: '5 hours ago' },
                { id: '5', title: 'Database Management Systems', code: 'DB301', students: 198, progress: 68, color: 'bg-gradient-to-r from-indigo-500 to-blue-500', lastActivity: '1 week ago' },
                { id: '6', title: 'Mobile App Development', code: 'MOB201', students: 234, progress: 55, color: 'bg-gradient-to-r from-teal-500 to-cyan-500', lastActivity: '2 days ago' },
              ].map((course, index) => (
                <CourseCard key={course.id} {...course} index={index} onClick={() => handleCourseClick(course.id)} />
              ))}
            </div>
          </section>
        </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: MessageSquare, title: 'New discussion in CS101', time: '5 minutes ago', description: 'John Doe started a discussion about recursion', color: 'bg-blue-100 text-blue-600' },
                      { icon: Clock, title: 'Assignment deadline approaching', time: '1 hour ago', description: 'Data Structures Lab 3 due in 2 days', color: 'bg-amber-100 text-amber-600' },
                      { icon: TrendingUp, title: 'Course progress update', time: '3 hours ago', description: '15 students completed Module 4 in WEB101', color: 'bg-green-100 text-green-600' },
                    ].map((activity, index) => (
                      <motion.div 
                        key={index}
