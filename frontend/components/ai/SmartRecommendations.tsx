  ...
  if (prioritizedLayout) {
        ...
        <div className={cn('', className)}>
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm text-gray-500 max-w-md mx-auto">
              As you engage with course materials, AI will provide personalized
              learning recommendations here.
            </p>
          </div>
        </div>
      );
    ...
    return (
      <div className={cn('space-y-6', className)}>
        ...
        {mustDo.length > 0 &&
          renderPriorityZone('Must-Do', 'mustDo', mustDo, 1)}
      ...
      <div className={cn('', className)}>
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="text-sm text-gray-500 max-w-lg mx-auto mb-4">
            AI-powered learning recommendations will appear here as you interact
                  ...
                  <div key={insight.metric} className="text-center">
                    <div className="flex items-center justify-center mb-2">
                      <IconComponent
                        className={cn(
                          'h-5 w-5',
                          getInsightColor(insight.status),
                        )}
                      />
                    </div>
                    <div className="text-2xl font-bold canvas-text mb-1">
                      {insight.value}%
                    </div>
                    <div className="text-xs canvas-body mb-2">
                      {insight.metric}
                    </div>
                    <div
                      className={cn(
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <h4 className="font-medium canvas-text">
                            {rec.title}
                          </h4>
                          <p className="text-sm canvas-body mt-1">
                            {rec.description}
                          </p>
                        </div>
                        <div className="flex items-center gap-2">
