...
export type CourseAction =
  ...
  | { type: 'UPDATE_MODULE'; payload: { moduleId: string; data: Partial<Module> } }
  ...
  | { type: 'DELETE_MATERIAL'; payload: { moduleId: string; materialId: string } }
  ...
  switch (action.type) {
    ...
    case 'ADD_MATERIAL':
      return {
        ...
        modules: state.modules.map(module =>
          module.id === action.payload.moduleId
            ? { ...module, materials: [...module.materials, action.payload.material] }
            : module
        )
      };
      ...
      return {
        ...
        modules: state.modules.map(module =>
          module.id === action.payload.moduleId
            ? {
                ...module,
                materials: module.materials.filter(m => m.id !== action.payload.materialId)
              }
            : module
        )
      };
...
export const courseActions = {
  setCourse: (course: Course): CourseAction => ({ type: 'SET_COURSE', payload: course }),
  setModules: (modules: Module[]): CourseAction => ({ type: 'SET_MODULES', payload: modules }),
  updateModule: (moduleId: string, data: Partial<Module>): CourseAction => ({
    type: 'UPDATE_MODULE',
    payload: { moduleId, data }
  }),
  deleteModule: (moduleId: string): CourseAction => ({ type: 'DELETE_MODULE', payload: moduleId }),
  addModule: (module: Module): CourseAction => ({ type: 'ADD_MODULE', payload: module }),
  toggleModule: (moduleId: string): CourseAction => ({ type: 'TOGGLE_MODULE', payload: moduleId }),
  ...
  setQuizzes: (quizzes: Quiz[]): CourseAction => ({ type: 'SET_QUIZZES', payload: quizzes }),
  setLoading: (loading: boolean): CourseAction => ({ type: 'SET_LOADING', payload: loading }),
  setError: (error: string | null): CourseAction => ({ type: 'SET_ERROR', payload: error }),
  setUser: (user: any): CourseAction => ({ type: 'SET_USER', payload: user }),
  setActiveTab: (tab: string): CourseAction => ({ type: 'SET_ACTIVE_TAB', payload: tab }),
  ...
  setSearchQuery: (query: string): CourseAction => ({ type: 'SET_SEARCH_QUERY', payload: query }),
