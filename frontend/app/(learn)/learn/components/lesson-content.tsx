      ...
      <div className="flex flex-col items-center justify-center min-h-96 bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="text-center max-w-md">
          ...
          <p className="canvas-body text-gray-600 mb-6">
            Analyzing your learning profile and adapting content to your
            preferred style...
          </p>
          <div className="flex items-center justify-center space-x-3">
            <div className="flex items-center space-x-2 bg-purple-50 px-4 py-2 rounded-lg border border-purple-200">
              ...
              <span className="canvas-small font-medium text-purple-700">
                Powered by AI
              </span>
            </div>
          </div>
    ...
    return (
      <div className="canvas-card bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="canvas-heading-2 mb-4">Ready to start learning?</h2>

          <p className="canvas-body text-gray-600 mb-8 max-w-md mx-auto">
            Choose a topic from the sidebar to begin your personalized learning
            journey.
          </p>
          ...
          {(progressPercentage > 0 || studyTime > 0) && (
            <div className="grid grid-cols-3 gap-4 mb-8 max-w-md mx-auto">
              <div className="canvas-card bg-green-50 border-green-200 p-4">
                ...
                <div className="canvas-heading-3 text-green-700">
              ...
              <div className="canvas-card bg-blue-50 border-blue-200 p-4">
                ...
                <div className="canvas-heading-3 text-blue-700">
                  {studyTime}m
                </div>
              </div>
          ...
          <div className="flex items-center justify-center space-x-2 text-purple-600">
            ...
            <span className="canvas-body font-medium">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="canvas-heading-3 text-emerald-700">
                  Learning Progress
                </span>
              </div>
              <Badge
            ...
            <div className="flex items-center justify-between">
              <span className="canvas-small text-emerald-600">
          ...
          <CardContent className="pt-6">
            ...
            <div className="canvas-card bg-amber-50 border border-amber-200 p-4">
              <p className="canvas-small text-amber-800 text-center flex items-center justify-center">
                <Lightbulb className="h-4 w-4 mr-2" />💡 Tip: Highlight any text
                for instant AI explanations and deeper insights
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="canvas-heading-3 text-gray-900">
                  Need more help with this lesson?
                </p>
                <p className="canvas-body text-gray-600">
                  Your AI tutor is ready to provide personalized explanations
