    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-lg p-4 mt-6">
        ...
        <p className="text-sm text-orange-800">
          Your topics and interests help us create personalized examples,
          analogies, and learning paths that connect new concepts to things you
      ...
      {formData.topics.length === 0 && (
        <div className="text-center p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-sm text-yellow-800">
            💡 <strong>Tip:</strong> Add at least one learning topic to get
            started with personalized content!
          </p>
        </div>
      )}
    </div>
