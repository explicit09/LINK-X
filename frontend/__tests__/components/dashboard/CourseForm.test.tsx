...
describe('CourseForm', () => {
  ...
  describe('Create Mode', () => {
    ...
    it('validates required fields', async () => {
      ...
      expect(
        await screen.findByText(/course code is required/i),
      ).toBeInTheDocument();
    ...
    it('validates course code format', async () => {
      ...
      expect(
        await screen.findByText(/course code must be alphanumeric/i),
      ).toBeInTheDocument();
    });
  ...
  describe('Edit Mode', () => {
    it('renders form with existing course data', () => {
      ...
      expect(
        screen.getByRole('button', { name: /update course/i }),
      ).toBeInTheDocument();
    });
    ...
    it('updates course successfully', async () => {
      ...
      await waitFor(() => {
        expect(api.courses.updateCourse).toHaveBeenCalledWith(
          existingCourse.id,
          {
            title: 'Updated Course Title',
            code: 'CS101',
  ...
  describe('Validation Rules', () => {
    ...
    it('validates maximum title length', async () => {
      ...
      expect(
        await screen.findByText(/title must not exceed 100 characters/i),
      ).toBeInTheDocument();
    });
    ...
    it('validates student limit range', async () => {
      ...
      expect(
        await screen.findByText(/must be at least 1/i),
      ).toBeInTheDocument();
